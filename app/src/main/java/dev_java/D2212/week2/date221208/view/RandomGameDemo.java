package dev_java.D2212.week2.date221208.view;
...
public class RandomGameDemo implements ActionListener {
  ...
  JButton jbtn_north = new JButton("북쪽");// 생서앚 파라미터는 String
  JButton jbtn_south = new JButton("남쪽");// 생서앚 파라미터는 String
  JButton jbtn_east = new JButton("동쪽");// 생서앚 파라미터는 String
  JButton jbtn_west = new JButton("서쪽");// 생서앚 파라미터는 String
  JButton jbtn_center = new JButton("중앙");// 생서앚 파라미터는 String
  // 생성부

  public RandomGameDemo() {
    System.out.println("디폴트생성자 호출완료");
    initDisplay();
  }
