...
public class Array extends Object {// 상속 - 확장, 재사용(오버라이딩경우), 재정의해서 쓴다.
  public static void main(String[] args) {
    ...
    try {
      ...
      // System.out.println(i[x]); 문법 에러
      // System.out.println(i[isOk]); 컴파일 오류

    } catch (ArrayIndexOutOfBoundsException e) {
      System.out.println("인덱스 범위를 넘었다");
    }
