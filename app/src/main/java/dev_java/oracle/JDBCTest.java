...
public class JDBCTest {
	// 이 클래스를 읽어야 오라클 제품인것을 확인가능함. - 제조업체 - 물리적으로 떨어져 있는
	// 오라클 서어베 접속이 가능하다 - ojdbc6.jar, ojdnc8.jar
	public static final String _DRIVER = "oracle.jdbc.driver.OracleDriver";//폴더
	// 물리적으로 떨어져 있는 오라클 서버에 URL정보 추가
	// 오라클 제품에서는 물리적으로 떨어져 있는 서버에 접속하는 방식으로 thin 방식과 oci방식지원
	// 멀티티어, 환명에서는 thin 방식이다. 서버의 DNS, 포트번호 - 1521, SID이름 - 물리적인 저장소 참조
